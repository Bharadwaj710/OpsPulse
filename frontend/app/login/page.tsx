    ...
    <div className="flex min-h-screen bg-white font-sans overflow-hidden">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-between p-8 md:p-12 lg:p-16 relative z-10 bg-white">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-bold text-lg text-slate-900 tracking-tight">OpsPulse</span>
        </div>
        ...
        <div className="max-w-[400px] w-full mx-auto my-auto py-12 space-y-8">
          <div className="space-y-3">
            <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 leading-tight">
              Welcome back <br />
              to <span className="text-blue-600">OpsPulse</span>
            </h1>
        ...
        <div className="text-xs text-slate-400">
          &copy; 2024 OpsPulse. All rights reserved.
        </div>
      </div>
